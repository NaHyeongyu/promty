...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("shared_scope", postgresql.JSONB(astext_type=sa.Text()), nullable=False, server_default=sa.text("'{}'::jsonb")),
    ...
    op.create_index("ix_published_prompts_source_activity_id", "published_prompts", ["source_activity_id"])
    op.create_index("ix_published_prompts_source_project_id", "published_prompts", ["source_project_id"])
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=UTC_NOW, nullable=False),
        sa.ForeignKeyConstraint(["published_prompt_id"], ["published_prompts.id"], ondelete="CASCADE"),
    )
    op.create_index(
    ...
    op.create_index("ix_published_prompt_comments_author_id", "published_prompt_comments", ["author_id"])
    op.create_index(
    ...
    op.create_index("ix_published_prompt_reactions_author_id", "published_prompt_reactions", ["author_id"])
    op.create_index(
...
def downgrade() -> None:
    op.drop_index("ix_published_prompt_reactions_prompt_id", table_name="published_prompt_reactions")
    op.drop_index("ix_published_prompt_reactions_author_id", table_name="published_prompt_reactions")
    op.drop_table("published_prompt_reactions")
    op.drop_index("ix_published_prompt_comments_prompt_id", table_name="published_prompt_comments")
    op.drop_index("ix_published_prompt_comments_author_id", table_name="published_prompt_comments")
    op.drop_table("published_prompt_comments")
    op.drop_index("ix_published_prompt_files_prompt_id", table_name="published_prompt_files")
